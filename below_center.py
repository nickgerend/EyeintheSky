...
df_dict_circle_1 = dict_start_end(df, 'User_Group', 1., 0, True) # item1
df_dict_circle_2 = dict_start_end(df, 'Orbit', factor, inc) # item 2
#endregion
...
# df_out.to_csv(os.path.dirname(__file__) + '/below_center_linear.csv', encoding='utf-8', index=False)
#endregion
...
min_x = -x_shift
import csv
with open(os.path.dirname(__file__) + '/below_center_curve.csv', 'w',) as csvfile:
