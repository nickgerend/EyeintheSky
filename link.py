...
# Layout:
# 'Year_Bin' + ' - ' +  'Purpose_Group'

# df_group_circle = df.groupby(['Purpose_Group', 'Year_Bin'], sort=False)
# df_dict_circle_1 = dict_start_end(df, 'Purpose_Group') # item1
# df_dict_circle_2 = dict_start_end(df, 'Year_Bin') # item 2
df_group_circle = df.groupby(['User_Group', 'Orbit'], sort=False)
df_dict_circle_1 = dict_start_end(df, 'User_Group') # item1
df_dict_circle_2 = dict_start_end(df, 'Orbit') # item 2
#endregion
...
df_out['link'] = 1
#df_out['link_name'] = 'Year_Bin' + ' - ' +  'Purpose_Group'
df_out['link_name'] = 'Orbit' + ' - ' +  'User_Group'
...
#df_out.to_csv(os.path.dirname(__file__) + '/Year_Bin_Purpose_Group_Link.csv', encoding='utf-8', index=False)
df_out.to_csv(os.path.dirname(__file__) + '/Orbit_User_Group.csv', encoding='utf-8', index=False)
#endregion
